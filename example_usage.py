...
from utils import conservative_phv_std_strategy,empirical_initial_model, create_layered_model, calculate_rms_misfit, calculate_enhanced_misfit, print_misfit_summary
...
if __name__ == "__main__":
    ...
    # %%
    """1D true inversion example with enhanced misfit evaluation"""
